        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#navbar-AOA" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-AOA">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#navbar-COA" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-COA">
                    ...
                    <div class="">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Overview of AOA</h5>
