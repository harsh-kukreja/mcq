                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" action="<?php $login->processLogin()?>" method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4" name="login">Log in</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
            <div class="col-xl-6">
                <div class="copyright text-center text-xl-left text-muted">
                    &copy; 2019 <a href="https://www.creative-tim.com/" class="font-weight-bold ml-1" target="_blank">StudyLink</a>
                </div>
            </div>
            <div class="col-xl-6">
